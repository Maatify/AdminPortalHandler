 ...
 * @Maatify   AdminPortalHandler :: Gender
 */
...
class Gender extends ParentClassHandler
{
    public const TABLE_NAME                 = 'gender';
    ...
    protected array $inner_language_tables = [GenderName::class];
    protected string $inner_language_name_class = GenderName::class;
